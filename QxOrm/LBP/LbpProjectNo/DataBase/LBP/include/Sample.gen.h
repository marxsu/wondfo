...
class history;
#include "LBP_export.gen.h"

class LBP_EXPORT sample
{
...
QX_REGISTER_COMPLEX_CLASS_NAME_HPP_LBP(sample, qx::trait::no_base_class_defined, 0, sample)

#include "../include/history.gen.h"
#include "../custom/include/Sample.h"
