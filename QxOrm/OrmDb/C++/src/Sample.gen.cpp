...
QX_REGISTER_COMPLEX_CLASS_NAME_CPP_LBP(sample, sample)
...
sample::sample() : m_Id(0), m_Type(0) { ; }

sample::sample(const long & id) : m_Id(id), m_Type(0) { ; }

sample::~sample() { ; }

long sample::getId() const { return m_Id; }
